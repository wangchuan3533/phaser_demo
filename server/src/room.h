...
public:
    ...
    bool player_join(session *s, const demo::protocol::JoinRoomReq &join_room_req, demo::protocol::JoinRoomRes &join_room_res);
    bool player_leave(session *s);
    bool player_action(uint32_t player_id, const demo::protocol::ActionReq &action_req, demo::protocol::ActionRes &action_res);
    bool update();
